        ...
        <div>
            ...
            >
                <div className="grid grid-cols-1  md:grid-cols-2   items-center">
                    <div className="md:py-[96px] py-18 pl-10  lg:pl-[140px] h-full" style={{ backgroundImage: "url('/home/Hero-right.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
                        <h5 className="font-semibold text-xl md:text-2xl lg:text-3xl xl:text-[40px] text-primaryColor mb-4">For Maid </h5>
                        <h2 className="text-3xl md:text-4xl lg:text-[64px] text-headerColor font-bold leading-[120%]"> <span className="text-redColor">No placement fee!</span> Transfer to new employer here </h2>
                    ...
                    <div className="md:py-[96px] py-18 pl-10 lg:pl-[140px] pr-10 lg:pr-[280px] h-full" style={{ backgroundImage: "url('/home/Hero-left.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }} >
                        <h5 className="font-semibold text-xl md:text-2xl lg:text-3xl xl:text-[40px] text-whiteColor mb-4">For Employer</h5>
                        <h2 className="text-3xl md:text-4xl lg:text-[64px] text-headerColor font-bold ">Looking for a transfer maid for your  <span className="text-redColor">Home?</span> </h2>
