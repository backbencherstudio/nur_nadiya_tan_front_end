        ...
        <div>
            <div
                ...
                <div className="grid grid-cols-1  md:grid-cols-2   items-center">
                    <div className="md:py-[96px] 3xl:pr-[160px] py-18 pl-10  xl:pl-[40px]   3xl:pl-[120px] h-full" style={{ backgroundImage: "url('/home/Hero-right.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}>
                    ...
                    <div className="md:py-[96px] py-18 pl-10 xl:pl-[40px]   3xl:pl-[140px] pr-10 lg:pr-14 xl:pr-[120px] 3xl:pr-[260px] h-full" style={{ backgroundImage: "url('/home/Hero-left.jpg')", backgroundSize: "cover", backgroundPosition: "center", backgroundRepeat: "no-repeat" }} >
                        <h5 className="font-semibold text-xl md:text-2xl lg:text-3xl xl:text-[40px] text-whiteColor mb-4">For Employer</h5>
                        <h2 className="text-3xl leading-[120%] md:text-4xl lg:text-5xl xl:text-[64px] text-headerColor font-bold ">Looking for a transfer maid for your  <span className="text-redColor">Home?</span> </h2>
