...
function DashboardUserTable({ recentOrder }: any) {
  ...
  const handle_export_pdf = () => {
    ...
    for (let i = 1; i <= pageCount; i++) {
      ...
      doc.text(
        ...
        (doc as any).internal.pageSize.width - 60,
        (doc as any).internal.pageSize.height - 10
      );
    }
        ...
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-gray-300 rounded-full flex items-center justify-center">
            <span className="text-xs font-medium text-gray-600">
              {record?.image_name ? (
                <Image
                  src={`${process.env.NEXT_PUBLIC_API_ENDPOINT}/uploads/${record?.image_name}`}
        ...
        <div className="change-arrow">
          <Select
            ...
            onValueChange={(new_status) =>
              handle_status_change(new_status, record)
            }
          ...
          >
            ...
            <SelectContent className="">
              ...
              <SelectItem
                className={"bg-greenColor/15 text-greenColor cursor-pointer !mb-1"}
                value="contacted"
              >
                Contacted
              </SelectItem>
  ...
  return (
    <section>
          ...
          <div className=" md:flex items-center gap-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 items-center gap-3  mt-4 md:mt-0">
              ...
              <button
                ...
                className="bg-[#C5EFF1] hover:bg-teal-200 text-teal-700 px-6 py-3 cursor-pointer rounded-lg transition-colors"
              >
                Export
              </button>
            </div>
      ...
      {isEdite && selectedEditRecord?.type == "Maid" ? (
        <TransferMaidForm
          open={isEdite}
          setOpen={setIsEdite}
