            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2">
                        <label className="text-sm md:text-base block mb-1.5">Full Name (Nama Penuh)</label>
                        <Input placeholder="Enter your name" className="w-full !h-10 md:!h-12" {...register("fullName", { required: true })} />
                    </div>

                    <div className="col-span-2 lg:col-span-1">
                        <label className="text-sm md:text-base block mb-1.5">Contact Number (Nombor Telefon)</label>
                        <Input placeholder="Enter your number" className="w-full !h-10 md:!h-12" {...register("contactNumber", { required: true })} />
                    </div>

                    <div className="col-span-2 lg:col-span-1">
                        <label className="text-sm md:text-base block mb-1.5">Email Address (Alamat Emal)</label>
                        <Input placeholder="Enter your email" className="w-full !h-10 md:!h-12" {...register("email", { required: true })} />
                    </div>

                    <div className="col-span-2 ">
                        <label className="text-sm md:text-base block mb-1.5">Type of Household (Jenis Isi Rumah)</label>
                    ...
                    <div className="col-span-2 lg:col-span-1">
                        <label className="text-sm md:text-base block mb-1.5">Preferred Languages (Bahasa Pilihan)</label>
                    ...
                    <div className="col-span-2 lg:col-span-1">
                        <label className="text-sm md:text-base block mb-1.5">Salary Budget Range (Anggaran Gaji)</label>
                        <Controller
                            name="salaryBudget"
                            control={control}
                            render={({ field }) => (
                    ...
                    <div className="col-span-2">
                        <label className="text-sm md:text-base block mb-1.5">Additional Requirements or Notes (Keperluan Tambahan)</label>
