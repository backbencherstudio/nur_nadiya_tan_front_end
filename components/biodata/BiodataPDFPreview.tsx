...
export default function BiodataPDFPreview({ biodata }: BiodataPDFPreviewProps) {
  ...
  return (
    <section className="pdf-safe-colors">
      ...
      <div
        ref={printRef}
        className="max-w-2xl mx-auto shadow-lg mt-5"
        style={{ backgroundColor: "#ffffff" }}
      >
        {/* Header */}
        <div
          className="py-4 px-6"
          style={{ backgroundColor: "rgba(69, 204, 210, 0.4)" }}
        >
          <div className="text-center">
            <h1
              className="text-2xl uppercase font-semibold mb-2"
              style={{ color: "#000000" }}
            >
              Biodata
            </h1>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className=" p-4">
            ...
            <div className="text-sm">{data.other_remarks || "N/A"}</div>
          </div>
        </div>
      </div>
    </section>
